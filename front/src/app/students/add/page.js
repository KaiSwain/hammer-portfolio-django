      ...
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block font-medium text-gray-700">Class Start Date</label>
              <input
                type="date"
                name="start_date"
            ...
            <div>
              <label className="block font-medium text-gray-700">Class End Date</label>
              <input
                type="date"
                name="end_date"
          ...
          {/* OSHA */}
          <h2 className="text-lg font-bold text-gray-800 mt-4 mb-2 uppercase"></h2>
          <div className="grid grid-cols-2 gap-4">
            <div>
            ...
            <div>
              <label className="block font-medium text-gray-700">OSHA 10 Completion Date</label>
              <input
                type="date"
          ...
          {/* Scores */}
          <h2 className="text-lg font-bold text-gray-800 mt-4 mb-2 uppercase">HammerMath Reading a Ruler Assessment</h2>
