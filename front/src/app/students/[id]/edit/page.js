    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-3xl mx-auto bg-white rounded-lg shadow p-6">
        ...
        <form onSubmit={handleSave} className="space-y-6">
          ...
          {/* DATES */}
          <section>
            <h2 className="text-sm font-bold text-gray-600 tracking-widest mb-2">DATES</h2>
          ...
          {/* OSHA */}
          <section>
            <h2 className="text-sm font-bold text-gray-600 tracking-widest mb-2">OSHA</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div>
                <label className="block text-sm font-medium text-gray-700">Pre-test Score</label>
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Post-test Score</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">16 Type Assessment</label>
