...
export default function StudentSummary({ student }) {
  ...
  const fields = [
    ...
    { label: "End Date", value: student.end_date ?? "-" },
    { label: "Complete 50 Hour Training", value: student.complete_50_hour_training ? "Yes" : "No" },
    { label: "Passed OSHA 10 Exam", value: student.passed_osha_10_exam ? "Yes" : "No" },
    { label: "OSHA Completion Date", value: student.osha_completion_date ?? "-" },
    { label: "OSHA Type", value: student.osha_type?.name ?? "-" },
    { label: "Hammer Math", value: student.hammer_math ? "Yes" : "No" },
    { label: "Employability Skills", value: student.employability_skills ? "Yes" : "No" },
    { label: "Passed Reading a Ruler Assessment", value: student.passed_ruler_assessment ? "Yes" : "No" },
    { label: "Pretest Score", value: student.pretest_score ?? "-" },
    { label: "Posttest Score", value: student.posttest_score ?? "-" },
    { label: "Disc Assessment Type", value: student.disc_assessment_type?.type_name ?? "-" },
    { label: "16 Type Assessment", value: student.sixteen_types_assessment?.type_name ?? "-" },
